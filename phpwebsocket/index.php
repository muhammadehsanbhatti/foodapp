...
<head>
	...
	$(document).ready(function(){
		...
		var websocket = new WebSocket("ws://localhost:82/gitlab/jugu_app/phpwebsocket/php-socket.php"); 
	...
	<body>
		<form name="frmChat" id="frmChat">
			<div id="chat-box"></div>
			<input type="text" name="chat-user" id="chat-user" placeholder="Name" class="chat-input" value="test name" required />
			<input type="text" name="chat-message" id="chat-message" placeholder="Message" value="test message"  class="chat-input chat-message" required />
