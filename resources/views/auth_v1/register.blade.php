...
<form class="auth-register-form mt-2" action="{{ route('accountRegister') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input value="{{old('first_name')}}" type="text" class="form-control @error('first_name') is-invalid @enderror form-control-merge" id="first_name" name="first_name" placeholder="john" aria-describedby="first_name" tabindex="1" />
        @error('first_name')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="form-group">
        ...
        <input value="{{old('last_name')}}" type="text" class="form-control @error('last_name') is-invalid @enderror form-control-merge" id="last_name" name="last_name" placeholder="doe" aria-describedby="last_name" tabindex="1" />
        @error('last_name')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
