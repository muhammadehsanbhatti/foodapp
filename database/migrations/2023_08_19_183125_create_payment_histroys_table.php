    ...
    public function up()
    {
        Schema::create('payment_histroys', function (Blueprint $table) {
            ...
            $table->foreign('user_id')->references('id')->on('users')->onUpdate('cascade')->onDelete('cascade');
             $table->unsignedBigInteger('payment_card_information_id')->nullable();
            ...
            $table->integer('order_completing_time')->nullable();
            ...
            $table->enum('delivery_status', ['Accept', 'Pending', 'Preparing', 'OnWay', 'Delivered','Customer Own Order Pickup'])->default('Pending');
