            ...
            @if (isset($data['records']) && count($data['records'])>0)
                ...
                @endphp
                    <tr>
                        ...
                        <td>
                            @canany(['general-title-update', 'general-title-delete'])
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    @can('general-title-update')
                                    <a class="dropdown-item" href="{{ url('general_title')}}/{{$item['id']}}/edit">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 mr-50"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                        <span>Edit</span>
                                    </a>
                                    @endcan
                                    
                                    @can('general-title-delete')

                                    <form action="{{ url('general_title/'.$item['id']) }}" method="post">
                                        @method('delete')
                                        @csrf
