@section('title', 'General Title List')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Filter General Title</h4>
                        </div>
                        
                        <div class="card-body">
                            <form method="GET" id="filterForm" action="{{ url('/general_title') }}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-1">    
                                        ...
                                        <select class="formFilter change_title select2 form-select" name="title" id="select2-title">
                                            ...
                                            @if (isset($data['general_title']) && count($data['general_title']) > 0 )
                                                @foreach ($data['general_title'] as $key => $title_obj)
